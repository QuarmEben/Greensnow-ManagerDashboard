...
<MetricDisplay 
        ...
        <EmployerDetailsDisplay name='Jacobs Construction'/>
    ...
    />
      ...
      <Text style={tw`my-auto text-base tracking-tight text-center text-zinc-600`}>+8 Rating</Text>
   </View>
   </View>
   ...
   {/* Link to employee profile  */}
    ...
    />
      ...
      <Text style={tw`my-auto text-base tracking-tight text-center text-zinc-600`}>+18 Assurance</Text>
      </View>
   </View>
   </View>
   ...
   {/* Job Seeker Performance Review */}
        ...
        <View style={tw`flex flex-col`}>
          {reviewData.map((conduct, index) => (
            
        <Text style={tw`my-auto text-base tracking-tight text-zinc-600`}>{conduct.name} - <Text style={tw`font-bold text-stone-900`}>{conduct.value}</Text></Text>
